...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        ...
        addMenu("Sản phẩm", "2", 1);
        addMenu("Bán hàng", "3", 2);
        addMenu("Hóa đơn", "4", 3);
        addMenu("Giảm giá", "5", 4);
        addMenu("Thông kê", "6", 5);

        addMenu("Khách hàng", "11", 6);
        addMenu("Nhân viên", "8", 7);
        addMenu("Biểu đồ", "9", 8);
        addMenu("Doanh thu", "10", 9);
        addMenu("Thống kê sản phẩm", "4", 10);
    ...
    private void initComponents() {
        ...
        menu.setForeground(new java.awt.Color(169, 224, 49));
