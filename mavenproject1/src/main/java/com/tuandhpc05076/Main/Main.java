...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        ThemeColorChange.getInstance().addThemes(new ThemeColor( new Color(80, 80, 80), Color.BLACK) {
            @Override
        ...
        ThemeColorChange.getInstance().addThemes(new ThemeColor(Color.BLACK,new Color(34, 34, 34)) {
            @Override
            public void onColorChange(Color color) {
...
//        if (!pro.isDarkMode()) {
        ...
        panelBackground1.setBackground(Color.BLACK);
                            ...
                            .addGroup(panelBackground1Layout.createSequentialGroup()
                                ...
                                .addGroup(panelBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(panelBackground1Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(textImage1, javax.swing.GroupLayout.PREFERRED_SIZE, 605, javax.swing.GroupLayout.PREFERRED_SIZE)))
